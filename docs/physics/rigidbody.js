...
export class RigidBody extends Script {
    ...
    findCollisions(transforms, collider, collisions) {
    ...
    findCollisionsInChildren(transforms) {
        for (const trans of transforms) {
            ...
            for (const collider of colliders) {
                ...
                for (const collision of collider.collisions) {
                    if (collisions.find(item => item.other === collision.other))
                        continue;
                    for (const comp of this.gameObject.getAllComponents()) {
                        if (collider.isTrigger) {
...
export class Collision {
    constructor(collider, other, mvt) {
