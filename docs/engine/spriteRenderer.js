...
export class SpriteRenderer extends Script {
    ...
    draw() {
        ...
        SceneManager.context.drawImage(this.sprite, this.transform.position.x - this.transform.scale.x, this.transform.position.y - this.transform.scale.y, this.transform.scale.x, this.transform.scale.y);
    }
}
